            ...
            <div class="row my-4">
                ...
                <div class="col-lg-4 col-md-6 mb-4" v-for="(product,index) in company.products.data" :key="index">
                    ...
                    <div class="card-footer card-footer-custom">
                        <a href="#" @click.prevent="addProdCart(product)">Adicionar no Carrinho <i class="fas fa-cart-plus"></i></a>
                    </div>
                    </div>
                </div>
...
export default {
    ...
    created()
    {
        ...
        this.getCategoriesByCompany(this.company.uuid)
             .catch(response => this.$vToastify.error('Falha ao carregar Categorias','Error'))   
this.loadproducts()
        //this.getProductsByCompany(this.company.uuid)
          //  .catch(response => this.$vToastify.error('Falha ao carregar os produtos','Error'))    

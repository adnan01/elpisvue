        ...
        <div class="d-flex justify-content-center form_container">
          ...
          <div class="text-danger" v-if="errors.name != ''">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" v-model="formData.name" name="name" :class="['form-control', 'input_user', {'is-invalid' :errors.name != ''}]" placeholder="Nome">
            </div>
            ...
            <div class="input-group mb-2">
              ...
              <input type="password" v-model="formData.password" name="password" :class="['form-control', 'input_user', {'is-invalid' :errors.password != ''}]"  placeholder="Senha">
            </div>
      ...
      this.register(this.formData)
          ...
          .catch(error => {
            ...
            if(errorResponse.status === 422)
            {
              ...
              this.$vToastify.error('Dados inválidos','Error')
              
              setTimeout(() => this.reset(), 3000)
              
              return;
            }
          this.$vToastify.error('Falha no cadastro','Error')
